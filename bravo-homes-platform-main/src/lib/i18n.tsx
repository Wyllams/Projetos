...
const T: Translations = {
  ...
  // ─── PROPOSALS ───
  proposalsManagement: { 'pt-BR': 'Gestão de Orçamentos', 'en-US': 'Proposal Management', es: 'Gestión de Presupuestos' },
  activeProposals: { 'pt-BR': 'Orçamentos Ativos', 'en-US': 'Active Proposals', es: 'Presupuestos Activos' },
  templatesLibrary: { 'pt-BR': 'Biblioteca de Modelos', 'en-US': 'Template Library', es: 'Biblioteca de Modelos' },
  createTemplate: { 'pt-BR': '⊕ Criar Modelo', 'en-US': '⊕ Create Template', es: '⊕ Crear Modelo' },
  newProposalBtn: { 'pt-BR': '+ Novo Orçamento', 'en-US': '+ New Proposal', es: '+ Nuevo Presupuesto' },
  activeProposalsCount: { 'pt-BR': 'propostas ativas', 'en-US': 'active proposals', es: 'presupuestos activos' },
  templatesInLibrary: { 'pt-BR': 'modelos na biblioteca', 'en-US': 'templates in library', es: 'modelos en biblioteca' },
  clientTitleProspect: { 'pt-BR': 'Cliente / Título (Prospect)', 'en-US': 'Client / Title (Prospect)', es: 'Cliente / Título (Prospecto)' },
  totalValueObj: { 'pt-BR': 'Valor Total', 'en-US': 'Total Value', es: 'Valor Total' },
  dateRegistered: { 'pt-BR': 'Data Cadastrada', 'en-US': 'Date Registered', es: 'Fecha Registrada' },
  viewedAt: { 'pt-BR': 'Visualizada em', 'en-US': 'Viewed at', es: 'Visto en' },
  signedAt: { 'pt-BR': 'Assinada em', 'en-US': 'Signed at', es: 'Firmado en' },
  noProposals: { 'pt-BR': 'Não há propostas geradas. Comece montando um Novo Orçamento!', 'en-US': 'No proposals generated. Start by creating a New Proposal!', es: 'No hay propuestas. ¡Comience creando un Nuevo Presupuesto!' },
  statusSigned: { 'pt-BR': '✓ Assinado', 'en-US': '✓ Signed', es: '✓ Firmado' },
  statusViewed: { 'pt-BR': 'Visto', 'en-US': 'Viewed', es: 'Visto' },
  statusRejected: { 'pt-BR': 'Declinado', 'en-US': 'Declined', es: 'Declinado' },
  statusSent: { 'pt-BR': 'Enviado', 'en-US': 'Sent', es: 'Enviado' },
  currencySymbol: { 'pt-BR': 'R$', 'en-US': '$', es: '$' },
  unlinkedClient: { 'pt-BR': 'Sem vínculo', 'en-US': 'Unlinked', es: 'Sin vincular' },
  syncing: { 'pt-BR': 'Sincronizando...', 'en-US': 'Syncing...', es: 'Sincronizando...' },
  pdfDownload: { 'pt-BR': '↓ PDF', 'en-US': '↓ PDF', es: '↓ PDF' },
  emptyTemplates: { 'pt-BR': 'Sua Biblioteca de Modelos está vazia. Adicione contratos ou esqueletos comerciais base.', 'en-US': 'Your Template Library is empty. Add contracts or base commercial frameworks.', es: 'Su Biblioteca de Modelos está vacía. Añada contratos o marcos comerciales base.' },
  templateBadge: { 'pt-BR': 'MODELO', 'en-US': 'TEMPLATE', es: 'MODELO' },
  templateDesc: { 'pt-BR': 'Variáveis permitidas e utilizadas no corpo do texto para injeção automática.', 'en-US': 'Allowed and utilized variables in text body for automatic injection.', es: 'Variables permitidas y utilizadas en el cuerpo de texto para inyección automática.' },
  useTemplate: { 'pt-BR': '▶ Usar', 'en-US': '▶ Use', es: '▶ Usar' },
  editBtn2: { 'pt-BR': '🖌️ Editar', 'en-US': '🖌️ Edit', es: '🖌️ Editar' },
  ...
  // ─── ADMIN FINANCES TAB ───
  financesTitle: { 'pt-BR': 'Financeiro', 'en-US': 'Finances', es: 'Finanzas' },
  grossRevenue: { 'pt-BR': 'Faturamento Bruto', 'en-US': 'Gross Revenue', es: 'Ingresos Brutos' },
  toReceive: { 'pt-BR': 'A Receber', 'en-US': 'To Receive', es: 'Por Cobrar' },
  paidReceived: { 'pt-BR': 'Recebido / Pago', 'en-US': 'Paid / Received', es: 'Cobrado / Pagado' },
  latestPayments: { 'pt-BR': 'Últimos Pagamentos', 'en-US': 'Latest Payments', es: 'Últimos Pagos' },
  serviceCol: { 'pt-BR': 'Serviço', 'en-US': 'Service', es: 'Servicio' },
  estValueCol: { 'pt-BR': 'Valor Est.', 'en-US': 'Est. Value', es: 'Valor Est.' },
  partnersCol: { 'pt-BR': 'Parceiro(s)', 'en-US': 'Partner(s)', es: 'Socio(s)' },
  percentageCol: { 'pt-BR': 'Porcentagem (%)', 'en-US': 'Percentage (%)', es: 'Porcentaje (%)' },
  paymentStatusCol: { 'pt-BR': 'Status do Pagto', 'en-US': 'Payment Status', es: 'Estado de Pago' },
  dateTimeCol: { 'pt-BR': 'Data / Hora', 'en-US': 'Date / Time', es: 'Fecha / Hora' },
  noPaymentsMsg: { 'pt-BR': 'Nenhum pagamento registrado ou lead atribuído.', 'en-US': 'No payments recorded or lead assigned.', es: 'Sin pagos registrados o lead asignado.' },
  pendingStatus: { 'pt-BR': 'pendente', 'en-US': 'pending', es: 'pendiente' },
  paidStatus: { 'pt-BR': 'pago', 'en-US': 'paid', es: 'pagado' },
  saveBtn: { 'pt-BR': 'Salvar', 'en-US': 'Save', es: 'Guardar' },
  naStatus: { 'pt-BR': 'N/D', 'en-US': 'N/A', es: 'N/A' },
  ...
  importCsvBtn: { 'pt-BR': '📥 Importar CSV', 'en-US': '📥 Import CSV', es: '📥 Importar CSV' },
  importingCsvBtn: { 'pt-BR': '⏳ Importando...', 'en-US': '⏳ Importing...', es: '⏳ Importando...' },
  exportCsvBtn: { 'pt-BR': '📤 Exportar', 'en-US': '📤 Export', es: '📤 Exportar' },
  ...
  loadingLP: { 'pt-BR': 'Carregando landing pages...', 'en-US': 'Loading landing pages...', es: 'Cargando landing pages...' },
  pageCityCol: { 'pt-BR': 'Página / Cidade', 'en-US': 'Page / City', es: 'Página / Ciudad' },
  visitorsCol: { 'pt-BR': 'Visitantes', 'en-US': 'Visitors', es: 'Visitantes' },
  leadsGeneratedCol: { 'pt-BR': 'Leads Gerados', 'en-US': 'Leads Generated', es: 'Leads Generados' },
  conversionCol: { 'pt-BR': 'Conversão (%)', 'en-US': 'Conversion (%)', es: 'Conversión (%)' },
  noLpFound: { 'pt-BR': 'Nenhuma Landing Page encontrada', 'en-US': 'No Landing Pages found', es: 'No se encontraron Landing Pages' },
  actionUpdateStatus: { 'pt-BR': 'Ação de atualizar status não implementada na interface estática.', 'en-US': 'Status update action not implemented in static UI.', es: 'Acción de actualizar estado no implementada en UI estática.' },
  copyLPLink: { 'pt-BR': 'Link copiado para a área de transferência', 'en-US': 'Link copied to clipboard', es: 'Enlace copiado al portapapeles' },
  lpBuilderSoon: { 'pt-BR': 'Construtor Visual chegará em breve!', 'en-US': 'Visual Builder coming soon!', es: '¡El Constructor Visual llegará pronto!' },
  deleteLpConfirm: { 'pt-BR': 'Deseja excluir', 'en-US': 'Do you want to delete', es: '¿Desea eliminar' },
  lpDeletedSuccess: { 'pt-BR': 'Landing Page excluída!', 'en-US': 'Landing Page deleted!', es: '¡Landing Page eliminada!' },
  newLPBtn: { 'pt-BR': '+ Nova LP', 'en-US': '+ New LP', es: '+ Nueva LP' },
  clickToToggleStatus: { 'pt-BR': 'Clique para alternar o status', 'en-US': 'Click to toggle status', es: 'Haga clic para cambiar el estado' },
  linkBtn: { 'pt-BR': 'Link', 'en-US': 'Link', es: 'Enlace' },
  ...
  newPartnerModalTitle: { 'pt-BR': 'Novo Parceiro / Contratado', 'en-US': 'New Partner / Contractor', es: 'Nuevo Socio / Contratista' },
  passwordLabel: { 'pt-BR': 'Senha de Acesso *', 'en-US': 'Access Password *', es: 'Contraseña de Acceso *' },
  passwordPlaceholder: { 'pt-BR': 'Min. 6 caracteres', 'en-US': 'Min. 6 chars', es: 'Mín. 6 caracteres' },
  cityLabel: { 'pt-BR': 'Cidade', 'en-US': 'City', es: 'Ciudad' },
  specialtyLabel: { 'pt-BR': 'Especialidade', 'en-US': 'Specialty', es: 'Especialidad' },
  createPartnerBtn: { 'pt-BR': 'Criar Parceiro', 'en-US': 'Create Partner', es: 'Crear Socio' },
  ...
  editProjectModalTitle: { 'pt-BR': 'Editar Projeto', 'en-US': 'Edit Project', es: 'Editar Proyecto' },
  newProjectModalTitle: { 'pt-BR': 'Criar Novo Projeto', 'en-US': 'Create New Project', es: 'Crear Nuevo Proyecto' },
  projectNamePlaceholder: { 'pt-BR': 'Ex: Reforma Cozinha Johnson', 'en-US': 'Ex: Johnson Kitchen Remodel', es: 'Ej: Remodelación Cocina Johnson' },
  serviceType: { 'pt-BR': 'Tipo de Serviço', 'en-US': 'Service Type', es: 'Tipo de Servicio' },
  contractValueLabel: { 'pt-BR': 'Valor do Contrato ($)', 'en-US': 'Contract Value ($)', es: 'Valor del Contrato ($)' },
  deadlineLabel: { 'pt-BR': 'Prazo Final', 'en-US': 'Deadline', es: 'Plazo Final' },
  startDateLabel: { 'pt-BR': 'Data de Início', 'en-US': 'Start Date', es: 'Fecha de Inicio' },
  existingOpt: { 'pt-BR': 'Existente', 'en-US': 'Existing', es: 'Existente' },
  newOpt: { 'pt-BR': 'Novo', 'en-US': 'New', es: 'Nuevo' },
  newClientPlaceholder: { 'pt-BR': 'Nome do novo cliente', 'en-US': 'New client name', es: 'Nombre del nuevo cliente' },
  createProjectBtn: { 'pt-BR': 'Criar Projeto', 'en-US': 'Create Project', es: 'Crear Proyecto' },
  reformaOp: { 'pt-BR': 'Reforma', 'en-US': 'Remodel', es: 'Remodelación' },
  reformaResidencialOp: { 'pt-BR': 'Reforma Residencial', 'en-US': 'Home Remodel', es: 'Remodelación Residencial' },
  newLeadModalTitle: { 'pt-BR': 'Cadastrar Novo Lead Manual', 'en-US': 'Register New Manual Lead', es: 'Registrar Nuevo Lead Manual' },
  clientNameLabel: { 'pt-BR': 'Nome do Cliente', 'en-US': 'Client Name', es: 'Nombre del Cliente' },
  estimatedValueLabel: { 'pt-BR': 'Valor Estimado', 'en-US': 'Estimated Value', es: 'Valor Estimado' },
  urgencyLabel: { 'pt-BR': 'Urgência', 'en-US': 'Urgency', es: 'Urgencia' },
  linkedPartnerLabel: { 'pt-BR': 'Parceiro Vinculado', 'en-US': 'Linked Partner', es: 'Socio Vinculado' },
  createLeadBtn: { 'pt-BR': 'Criar Lead', 'en-US': 'Create Lead', es: 'Crear Lead' },
  otherOp: { 'pt-BR': 'Outro', 'en-US': 'Other', es: 'Otro' },
  scheduleInspectionPrefix: { 'pt-BR': 'Agendar Vistoria: ', 'en-US': 'Schedule Inspection: ', es: 'Programar Inspección: ' },
  createNewSchedule: { 'pt-BR': 'Criar Novo Agendamento', 'en-US': 'Create New Schedule', es: 'Crear Nueva Cita' },
  associatedLeadOpt: { 'pt-BR': 'Lead Associado (Opcional)', 'en-US': 'Associated Lead (Optional)', es: 'Lead Asociado (Opcional)' },
  eventTitleLabel: { 'pt-BR': 'Título do Evento', 'en-US': 'Event Title', es: 'Título del Evento' },
  eventTitlePlaceholder: { 'pt-BR': 'Ex: Vistoria Inicial', 'en-US': 'Ex: Initial Inspection', es: 'Ej: Inspección Inicial' },
  dateLabel: { 'pt-BR': 'Data', 'en-US': 'Date', es: 'Fecha' },
  timeLabel: { 'pt-BR': 'Horário', 'en-US': 'Time', es: 'Hora' },
  createScheduleBtn: { 'pt-BR': 'Criar Agendamento', 'en-US': 'Create Schedule', es: 'Crear Cita' },
  
  // ─── SETTINGS ───
  notifGranted: { 'pt-BR': '✅ Notificações ativadas', 'en-US': '✅ Notifications enabled', es: '✅ Notificaciones activadas' },
  notifDenied: { 'pt-BR': '🚫 Notificações bloqueadas', 'en-US': '🚫 Notifications blocked', es: '🚫 Notificaciones bloqueadas' },
  notifNotActivated: { 'pt-BR': '⚠️ Notificações não ativadas', 'en-US': '⚠️ Notifications not activated', es: '⚠️ Notificaciones no activadas' },
  notifGrantedToast: { 'pt-BR': '✅ Notificações ativadas!', 'en-US': '✅ Notifications enabled!', es: '✅ Notificaciones activadas!' },
  notifDeniedToast: { 'pt-BR': '❌ Permissão negada.', 'en-US': '❌ Permission denied.', es: '❌ Permiso denegado.' },
  enableNotifs: { 'pt-BR': 'Ativar Notificações', 'en-US': 'Enable Notifications', es: 'Activar Notificaciones' },
  selectOpt: { 'pt-BR': '-- Selecione --', 'en-US': '-- Select --', es: '-- Seleccionar --' },
  tzEST: { 'pt-BR': 'América/New York (EST)', 'en-US': 'America/New York (EST)', es: 'América/New York (EST)' },
  tzCST: { 'pt-BR': 'América/Chicago (CST)', 'en-US': 'America/Chicago (CST)', es: 'América/Chicago (CST)' },
  tzMST: { 'pt-BR': 'América/Denver (MST)', 'en-US': 'America/Denver (MST)', es: 'América/Denver (MST)' },
  tzPST: { 'pt-BR': 'América/Los Angeles (PST)', 'en-US': 'America/Los Angeles (PST)', es: 'América/Los Angeles (PST)' },
  tzBRT: { 'pt-BR': 'América/São Paulo (BRT)', 'en-US': 'America/Sao Paulo (BRT)', es: 'América/Sao Paulo (BRT)' },
  langPT: { 'pt-BR': 'Português (Brasil)', 'en-US': 'Portuguese (Brazil)', es: 'Portugués (Brasil)' },
  langEN: { 'pt-BR': 'English (US)', 'en-US': 'English (US)', es: 'Inglés (EEUU)' },
  langES: { 'pt-BR': 'Español', 'en-US': 'Spanish', es: 'Español' },
